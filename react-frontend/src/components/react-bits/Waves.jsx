...
/**
 * React Bits - Waves Background Component
 * Custom-tuned for LinkGuard Defense System:
 * - Default lineColor: 'rgba(217, 186, 132, 0.45)' (Champagne Gold) to ensure visibility on dark backgrounds
 * - Safe bounding-box fallback preventing 0x0 canvas collapse
 * - Supports fixed / absolute positioning and custom zIndex
 */
export default function Waves({
  lineColor = 'rgba(217, 186, 132, 0.45)', // Champagne Gold visible on dark theme!
  ...
  useEffect(() => {
    ...
    function setSize() {
      ...
      boundingRef.current = { width: w, height: h, left: rect.left, top: rect.top };
      canvas.width = w;
      canvas.height = h;
    }
