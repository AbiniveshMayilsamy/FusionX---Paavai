...
export function SustainabilityTab({ onGenerateEsgReport, onAssessSuppliers, onCalculateFootprint }) {
  return (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', margin: '20px 0' }}>
        <div className="card" style={{ marginBottom: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <button className="btn" onClick={onGenerateEsgReport} style={{ background: 'linear-gradient(135deg, #059669, #10b981)', color: '#fff' }}>
              🌱 Generate Comprehensive ESG Report
            </button>
            <button className="btn btn-secondary" onClick={onAssessSuppliers}>
        ...
        <div className="card" style={{ marginBottom: 0 }}>
          ...
          <button className="btn" onClick={onCalculateFootprint} style={{ background: 'linear-gradient(135deg, #0d9488, #14b8a6)', color: '#fff' }}>
